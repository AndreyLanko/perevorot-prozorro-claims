...
return [
    ...
    'list' => [
        ...
        'search_prompt' => 'Пошук...',
        'no_records' => 'За вашим запитом нічого не знайдено.',
        ...
        'pagination' => 'Записи: :from-:to з :total',
        'prev_page' => 'Попередня сторінка',
        'next_page' => 'Наступна сторінка',
        'loading' => 'Завантаження...',
        'setup_title' => 'Налаштування списку',
        'setup_help' => 'Використовуйте чекбокси для вибору колонок які ви хочете бачити в списку. Ви можете змінити послслідовність стовбчиків: перетягніть ії вверх чи вниз',
        'records_per_page' => 'Кількість записів на сторінці',
        'records_per_page_help' => 'Оберіть кількість записів. Увага: велика кількість записів може призвести до зниження швидкості роботи сторінки',
